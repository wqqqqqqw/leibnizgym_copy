...
def launch_rlg_hydra(cfg: DictConfig):
    ...
    OmegaConf.update(cfg,"args[offline]",True)
    OmegaConf.update(cfg,"args[num_envs]",1)
    #OmegaConf.update(cfg,"args[checkpoint]",'/data/user/wanqiang/document/leibnizgym/output/2024-04-14/16-21-53/PPO_continuous_itera720.pth')
    OmegaConf.update(cfg,"args[wandb_log]",False)
    OmegaConf.update(cfg,"gym[control_decimation]",30)
    ...
    #print(OmegaConf.to_yaml(cfg.gym))
    run_rlg_hydra(cfg)
